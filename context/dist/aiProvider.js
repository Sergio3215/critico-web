...
var ai_1 = require("ai");
var aiContext_1 = require("./aiContext");
function AiProvider(_a) {
    var _this = this;
    var children = _a.children;
    var handlerAiStream = function (url) { return __awaiter(_this, void 0, void 0, function () {
        var stream;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    process.env.GOOGLE_GENERATIVE_AI_API_KEY = process.env.NEXT_PUBLIC_GOOGLE_GENERATIVE_AI_API_KEY;
                    return [4 /*yield*/, ai_1.streamText({
                            model: google_1.google("models/gemini-1.5-flash-latest"),
                ...
                case 1:
                    stream = _a.sent();
                    return [2 /*return*/, stream.textStream];
            }
        });
    }); };
    return (React.createElement(aiContext_1.AiContext.Provider, { value: { handlerAiStream: handlerAiStream } }, children));
}
